...
var _createNodeMock = require('../../../support/createNodeMock');
...
test('Hue renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Hue2.default, _color.red), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
  expect(tree).toMatchSnapshot();
});

test('Hue renders vertically', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Hue2.default, _extends({}, _color.red, { width: 20, height: 200, direction: 'vertical' })), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
  expect(tree).toMatchSnapshot();
});

test('Hue renders custom styles correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Hue2.default, _extends({}, _color.red, { styles: { default: { picker: { boxShadow: '0 0 10px red' } } } })), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
