...
test('Alpha renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Alpha2.default, _color.red), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
...
test('Saturation renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Saturation2.default, _color.red), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
  expect(tree).toMatchSnapshot();
});
