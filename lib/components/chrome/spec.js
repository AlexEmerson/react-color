...
test('Chrome renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Chrome2.default, _color.red), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
...
test('Chrome renders custom styles correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Chrome2.default, { styles: { default: { picker: { boxShadow: 'none' } } } }), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
  expect(tree.props.style.boxShadow).toBe('none');
});

test('Chrome renders correctly with width', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Chrome2.default, { width: 300 }), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
