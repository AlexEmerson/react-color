...
test('Slider renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Slider2.default, _color.red), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
  expect(tree).toMatchSnapshot();
});

test('Slider renders custom styles correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Slider2.default, { styles: { default: { wrap: { boxShadow: 'none' } } } }), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
