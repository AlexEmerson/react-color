...
test('Alpha renders vertically', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Alpha2.default, _extends({}, _color.red, { width: 20, height: 200, direction: 'vertical' })), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
  expect(tree).toMatchSnapshot();
});
