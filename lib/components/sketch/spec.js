...
test('Sketch renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Sketch2.default, _color.red), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
...
test('Sketch renders custom styles correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Sketch2.default, { styles: { default: { picker: { boxShadow: 'none' } } } }), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
