...
test('Photoshop renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Photoshop2.default, _extends({}, _color.red, { onAccept: function onAccept() {}, onCancel: function onCancel() {} })), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
  expect(tree).toMatchSnapshot();
});

test('Photoshop renders custom styles correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Photoshop2.default, _extends({}, _color.red, { styles: { default: { picker: { boxShadow: '0 0 10px red' } } } })), { createNodeMock: _createNodeMock.createNodeMock }).toJSON();
